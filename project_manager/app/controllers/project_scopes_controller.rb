  ...
  def create
    ...
    respond_to do |format|
      if @project_scope.save
        format.html { redirect_to(@project_scope, :notice => 'Project scope was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @project_scope.update_attributes(params[:project_scope])
        format.html { redirect_to(@project_scope, :notice => 'Project scope was successfully updated.') }
        format.xml  { head :ok }
      else
